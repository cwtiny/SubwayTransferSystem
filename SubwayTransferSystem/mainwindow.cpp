...
void MainWindow::drawStations (const QList<int>& stationsList)
{
    for (int i=0; i<stationsList.size(); ++i)
    {
        ...
        // 在场景中添加圆形，QGraphicsEllipseItem圆形图元类
...
void MainWindow::transferQuery()
{
    ...
    // 判定用户选择的是“最少换乘次数”查询还是“换乘时间最短”路线查询
